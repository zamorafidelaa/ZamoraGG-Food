...
<div className="p-4 sm:p-6 bg-gray-50 min-h-screen">
  ...
  {loading ? (
    ...
    <p className="text-gray-400 text-center text-base sm:text-lg mt-6">No unassigned orders.</p>
  ) : (
        ...
        {orders.map((order) => (
          ...
          >
            <div className="mb-4 text-sm sm:text-base">
              ...
              <p className="text-gray-400 text-xs sm:text-sm mt-1">Created: {new Date(order.createdAt).toLocaleString()}</p>
            </div>
